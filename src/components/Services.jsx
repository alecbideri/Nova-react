...
const Services = () => {
  return (
    <section className="w-full bg-[#F1F1FF] py-20 px-4 sm:px-6 md:px-10 lg:px-32" id="services">
      <div className="flex flex-col items-center ">
        ...
        {/* Services Cards */}
        <div className="flex flex-col md:flex-row justify-between gap-8 p-6 md:px-0 md:gap-4 lg:px-0">
          {Array(3).fill(null).map((_, idx) => (
            <div
              key={idx}
              className="group max-w-[90%] sm:max-w-[45%] md:max-w-[30%] mx-auto flex flex-col items-center gap-5 border p-5 border-[#0000BF] bg-white transition-all duration-300 ease-in-out hover:bg-[#0000BF]"
            >
              {/* Icon */}
              <div>
                <HandCoins
